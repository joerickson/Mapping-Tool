// POST /api/analyses/account/[accountId]/clients/[clientId]/risk-flags-bulk
// Bulk-assess risk flags for every property tied to this (account, client)
// pair. Concurrency is bounded. Runs synchronously inside the request so the dashboard knows
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const branchSet = await fetchLatestBranchSet(db, accountId, clientId)
